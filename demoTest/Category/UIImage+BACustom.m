...
static NSTimeInterval BA_CGImageSourceGetGIFFrameDelayAtIndex(CGImageSourceRef source, size_t index) {
...
@implementation UIImage (BACustom)
...
+ (UIImage *)imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale
{
    ...
    for (size_t i = 0; i < count; i++) {
        NSTimeInterval delay = BA_CGImageSourceGetGIFFrameDelayAtIndex(source, i);
        totalTime += delay;
