...
- (void)setupSubView
{
    ...
    myIncomLabel.textColor = BA_White_Color;
    ...
    incomRankLabel.textColor = BA_White_Color;
    ...
    incomTotalLabel.textColor = BA_NaviBgBlueColor;
    incomTotalLabel.textAlignment = NSTextAlignmentCenter;
    incomTotalLabel.font = BA_FontSize(20);
    ...
    encourageLabel.textColor = BA_NaviBgBlueColor;
    encourageLabel.textAlignment = NSTextAlignmentCenter;
    encourageLabel.font = BA_FontSize(14);
    ...
    encourageDataLabel.textColor = BA_NaviBgBlueColor;
    encourageDataLabel.textAlignment = NSTextAlignmentCenter;
    encourageDataLabel.font = BA_FontSize(14);
    ...
    punishLabel.font = BA_FontSize(14);
    ...
    punishDataLabel.font = BA_FontSize(14);
