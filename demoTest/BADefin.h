 ...
 * 随机数据
 */
#define BARandomData arc4random_uniform(5)
...
// 警告框-一个按钮【View】
#define SHOW_AlertAtView(msg) [[[UIAlertView alloc] initWithTitle:@"温馨提示：" message:msg delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil] show];
